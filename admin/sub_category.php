...
if (isset($_POST['sub_category_submit'])) {
    ...
    $sub_category_insert = $connection->query("INSERT INTO `sub_category`( `category_id`, `sub_category_name`) VALUES ('$category_id','$sub_category_name')");
    if ($sub_category_insert) {
        $result = 1;
    } else {
        $result = 2;
    }
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Insert Sub Category </h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-primary" name="sub_category_submit">Submit</button>
                                </div>
                            </div>
                            </form>
                        </div>
